...
export const RED: ColorScheme = {
  schemeColorDarkest: '#d90000',
  schemeColorDark: '#f30000',
  schemeColorLight: '#ff0d0d',
  schemeColorLightest: '#ff2727',
  hoverColorDark: '#c00000',
  hoverColorLight: '#da0000',
  hoverColorLightest: '#ff0e0e',
  textColorPrimary: '#fff',
  textColorSecondary: '#fff',
  textColorTertiary: '#5a0000',
  borderColor: '#a60000',
}
